...
public class DetailChatGuru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final BottomSheetDialog mBottomSheetDialog = new BottomSheetDialog(DetailChatGuru.this);
                View sheetView = DetailChatGuru.this.getLayoutInflater().inflate(R.layout.pop_up_image_camera, null);
...
//                                    reference1.child(uploadID).setValue(upload);
                                    Toast.makeText(DetailChatGuru.this, "Upload Image Success", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(DetailChatGuru.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
...
//            Toast.makeText(DetailChat.this, "No file selected", Toast.LENGTH_SHORT).show();
    ...
    public void addMessageBox(String message, String imgUrl, int type){
        TextView textView = new TextView(DetailChatGuru.this);
        textView.setText(message);
        ImageView imgChat = new ImageView(DetailChatGuru.this);
